...
`,
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			result, err := ParseYAML(tt.yamlContent)
			if (err != nil) != tt.wantErr {
				t.Errorf("ParseYAML() error = %v, wantErr %v", err, tt.wantErr)
				return
			}
			if !tt.wantErr && result == nil {
				t.Errorf("ParseYAML() returned nil result for valid YAML")
			}
		})
	}
}
...
func TestValidateYAML(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			err := ValidateYAML(tt.yamlContent)
			if (err != nil) != tt.wantErr {
...
func TestReadAndParseYAMLFile(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			result, err := ReadAndParseYAMLFile(tt.filePath)
			if (err != nil) != tt.wantErr {
				t.Errorf("ReadAndParseYAMLFile() error = %v, wantErr %v", err, tt.wantErr)
				return
			}
			if !tt.wantErr && result == nil {
				t.Errorf("ReadAndParseYAMLFile() returned nil result for valid YAML file")
			}
		})
	}
}
